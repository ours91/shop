...
public class AMapLocationClientUtils {
    ...
    private Notification buildNotification() {
        ...
        builder.setSmallIcon(R.mipmap.ic_launcher)
                .setContentTitle(BaseUtils.getAppName(context))
    ...
    AMapLocationListener locationListener = new AMapLocationListener() {
        ...
        public void onLocationChanged(AMapLocation location) {
            if (null != location) {
                ...
                sb.append("****************").append("\n");
                //定位之后的回调时间
                sb.append("回调时间: " + BaseUtils.formatUTC(System.currentTimeMillis(), "yyyy-MM-dd HH:mm:ss") + "\n");
                //解析定位结果，
                String result = sb.toString();
                MyLog.w(TAG, result);
            } else {
                BaseUtils.showToast("定位失败，loc is null", context);
            }
        }
    };
}
